...
```{r}
data_everything = read_csv(here::here("Data_of_everything_updated.csv")) %>% 
...
```{r}
data_split = initial_split(data_everything, prop = 0.75, strata = occurance_status)
