...
OneBigDataSet <- rbind(occurences, random_points)
```

```{r}
testSet = c(
  terra::extract(temp_ssp2_2020, All_occurance), 
  terra::extract(temp_ssp4_2020, All_occurance),
  terra::extract(chl_ssp2_2020, All_occurance), 
  terra::extract(chl_ssp4_2020, All_occurance),
  terra::extract(mld_ssp2_2020, All_occurance), 
  terra::extract(mld_ssp4_2020, All_occurance)
   ) %>%
  cbind(OneBigDataSet) 
...
names(testSet) <- c("temp_ssp2_20","temp_ssp4_20","chl_ssp2_20","chl_ssp4_20","mld_ssp2_20", "mld_ssp4_20", "occurance_status", "geometry")
```
