...
time1 = c('2020-01-01T00:00:00Z', '2020-01-01T00:00:00Z')
constraints1 = list(time1, latitude, longitude)
names(constraints1) = c("time", "latitude", "longitude")
```
...
temp_ssp2_2020 <- download_layers(dataset_id = "thetao_ssp245_2020_2100_depthsurf", variables = "thetao_mean", constraints = constraints1)



#downloading layer to the according varibale 
mld_ssp2_2020 <- download_layers(dataset_id = "mlotst_ssp245_2020_2100_depthsurf", variables = "mlotst_mean", constraints = constraints1)



# downloading layer 
chl_ssp2_2020 <- download_layers(dataset_id = "chl_ssp245_2020_2100_depthsurf", variables = "chl_mean", constraints = constraints1)
```
...
temp_ssp4_2020 <- download_layers(dataset_id = "thetao_ssp460_2020_2100_depthsurf", variables = "thetao_mean", constraints = constraints1)



#downloading layer to the according varibale 
mld_ssp4_2020 <- download_layers(dataset_id = "mlotst_ssp460_2020_2100_depthsurf", variables = "mlotst_mean", constraints = constraints1)


# downloading layer 
chl_ssp4_2020 <- download_layers(dataset_id = "chl_ssp460_2020_2100_depthsurf", variables = "chl_mean", constraints = constraints1)
```
...
>>>>>>> 0b448ebc2c85bc919e1af0549836f6d5af1c14b4
```
...
names(testSet) <- c("temp_ssp2_20","temp_ssp4_20","chl_ssp2_20","chl_ssp4_20","mld_ssp2_20","mld_ssp4_20",
                         "temp_ssp2_50","temp_ssp4_50","chl_ssp2_50","chl_ssp4_50","mld_ssp2_50", "mld_ssp4_50",
                         "temp_ssp2_90","temp_ssp4_90","chl_ssp2_90","chl_ssp4_90","mld_ssp2_90", "mld_ssp4_90",
...
generating into csv
```{r}
write.csv(testSet2, "Data_of_everything.csv")
```
